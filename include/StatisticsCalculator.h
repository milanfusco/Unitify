 ...
 *
 * The StatisticsCalculator class provides static methods to compute various
 * statistical measures (mean, median, and mode) from a collection of
 * measurements. This class is designed to handle common statistical operations
 * that may be required for analyzing sets of measurements.
 *
 * @version 0.1
 */
 ...
 * @brief A utility class for calculating statistical measures of a collection
 * of measurements.
 *
 * The StatisticsCalculator class provides static methods to compute the mean,
 * median, and mode of a vector of Measurement objects. These methods can be
...
class StatisticsCalculator {
 public:
   ...
   *
   * Calculates the average (mean) value of the provided vector of Measurement
   * objects.
   *
   ...
   *
   * Determines the mode (most frequently occurring value) of the provided
   ...
   * Measurement objects. The input vector may be modified during this
   * operation.
   *
   * @param measurements A vector containing Measurement objects. The vector may
   * be modified.
