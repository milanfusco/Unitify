 ...
 *
 * This file contains the declaration of the IOStreamHandler class, which
 * provides static methods to facilitate reading and writing Measurement objects
 * to and from input and output streams.
 */
...
class IOStreamHandler {
 public:
   ...
   *
   * This static method serializes a Measurement object and writes it to the
   * output stream.
   *
   * @param out The output stream to write to (e.g., std::cout).
   * @param m The Measurement object to be written to the stream.
   * @return A reference to the output stream after writing the Measurement
   * object.
   */
   ...
   *
   * This static method deserializes data from the input stream and populates a
   * Measurement object.
   *
   ...
   * @return A reference to the input stream after reading the Measurement
   * object.
   */
